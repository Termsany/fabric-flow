...
import { useSettingsPaymentMethods, useUpdateSettingsPaymentMethod } from "@/hooks/use-payment-methods";
...
export function PaymentSettingsPage() {
  ...
  const { data: methods = [], isLoading, error } = useSettingsPaymentMethods();
  const updateMutation = useUpdateSettingsPaymentMethod();
  ...
  const saveRecord = async (record: TenantPaymentMethodRecord, form: Record<string, unknown>) => {
  ...
  return (
    <Layout>
      <PageHeader title={t.paymentMethodsSettingsTitle} subtitle={t.paymentMethodsSubtitle} />
